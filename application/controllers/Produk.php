...
class Produk extends CI_Controller {
	...
	public function insert_produk(){
	    ...
	    if(!empty($_FILES['filefoto']['name'])){
	        ...
	        if ($this->upload->do_upload('filefoto')){
				...
				$this->M_produk->tambah_produk($idproduk,$nama_produk,$keterangan,$idkat,$stok,$harga,$gambar,$berat);
				echo "<script>
	...
	function update_produk2(){
				...
				$harga=$this->input->post('harga');
				$berat = $this->input->post('berat');
				$this->M_produk->update_produk($id_produk,$nama_produk,$keterangan,$kategori,$stok,$harga,$idkat,$berat);
				echo "<script>
