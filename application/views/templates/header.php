                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <li class="nav-item active"><i class="fas fa-shopping-cart"></i>
                                ...
                                <li class="nav-item">
                                    <a data-scroll-nav="0" href="<?php echo base_url('Transaksi'); ?>">Transaksi Anda</a>
                                </li>
                                <li class="nav-item">
                                    <div class="dropdown" >
                                        <a class=" dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-user"></i>
                                        Hai ,<?php echo $this->session->userdata("namauser"); ?>!</a>
